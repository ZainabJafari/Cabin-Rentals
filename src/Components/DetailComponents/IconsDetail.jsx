...
import HomeReview from "../../Components/DetailComponents/Reviews";

const IconsDetail = () => {
  const { startDate, endDate, getFormattedDate, updateStartDate } =
    useDateContext();
    ...
    {/*   cabin fasilities */}
      <div className="part-one">
        {cabinDetail.property.map((description, index) => (
          <div key={index}>
            <div
              key={description.Washingmachine}
            >
            ...
            <div
              key={description.Privateparking}
            >
      ...
      {<div className="">
          <div key={cabinDetail._id} className="part-one">
            <div>
            <Charging />
            <p>Charging</p>
            </div>
        ...
        <div>
          <Link to={"/login"} className="btn-btn">
            <button className="reserv">Reserve</button>
          </Link>
        </div>
      </div>

...
const BookningInformation = () => {
  ...
  return (
    <div className='booking-information'>
        ...
        <p className='line'>___________________________________________________________________________________________________________________________________________________</p>
        <div>
        <UserRegister/>
        </div>
        </div>

...
const Nav = () => {
  ...
  return (
    <div className='card'>
      <div className='mobil'> <Navbar/> </div>
      <div className='navlink'>
        <img className='home-nav-logo' src={logo} alt="logo" />
        <div className='navlink-link'>

          <Link to={'/cabinlist'}className='btn-btn' ><li className='navbar-link-li'>Cabins</li></Link>
        <Link to={'/login'}><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
      ...
      <h1 className='h1'>Explore our luxury & </h1> 
      <h1 className='h1'>romantic cabins for couples</h1>
      ...
      <div className='hero'>
        ...
        <div className=''>
          <div className='hero-container-last-child'> 
          <div className='dropdown'>
            <p className='hero-text'>Package</p>
            <p className='date'>All</p>
            <Link to={'/cabinlist'}> <button className='home-nav-search'>SEARC</button> </Link>  
          </div>
          </div>
          <div>
            <HomeNavDropdown />
        ...
        <div>
        <Link to={'/cabinlist'}><svg className='home-nav-svg' xmlns="http://www.w3.org/2000/svg" width="37" height="37" viewBox="0 0 37 37" fill="none">
